...
class HW4Sampletests_part1(unittest.TestCase):
    ...
    def test_counttomark2(self):
        # mark 10 20 30 40 mark cleartomark
        mark()
        opPush(10)
        opPush(20)
        opPush(30)
    ...
    def test_getinterval2(self):
        #[4 5 3 5 5 True 4] 0 7 get
        opPush([4,5,3,5,5,True,4])
        opPush(0)
        opPush(7)
        getinterval()
        self.assertEqual(opPop(),[4,5,3,5,5,True,4])         
        self.assertTrue(len(opstack)==0)        
    ...
    def test_putinterval2(self):
        ...
        opPush([4,5,1,0])
        putinterval()
        self.assertEqual(opPop(),[4,5,1,0,5,True,4])
        self.assertTrue(len(opstack)==0)
    ...
    def test_beginEnd2(self):
        ...
        self.assertEqual(lookup('x'),None)
