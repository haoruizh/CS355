...
class HW4_part2_SampleTests(unittest.TestCase):
    ...
    def test_input13(self):
        testinput13 = """
            /a [100 200 30 40 50] def 
            a { dup add } forall add mul
        """
        interpreter(testinput13)
        result = [200, 400, 10800]
        self.assertEqual(opstack, result)
    ...
    def test_input14(self):
        ...
        [3 2 1 3 2 2 3 5 5] dup  
            3
            [4 2 1 4 2 3 4 5 1 9 1 2] 6 6 getinterval
            putinterval
        """
        interpreter(testinput14)
        result = [[3, 2, 1, 4, 5, 1, 9, 1, 2]]
        self.assertEqual(opstack, result)

    def test_input15(self):
        test_input15 = """
            /N 5 def 
             N { N N mul /N N 1 add def} repeat dup mul
        """
        interpreter(test_input15)
        result = [25, 36, 49, 64, 6561]
        self.assertEqual(opstack, result)
    ...
    def test_input16(self):
        test_input16 = """
            ...
            0 [8 -4 1 5 1]     
            {square} forall 
            55 eq false and {7 add} if
          """
        interpreter(test_input16)
        result = [0, 64, 1, 25]
        self.assertEqual(opstack, result)
